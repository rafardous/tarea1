...
public class HistorialPrestamoBibliotecario extends JPanel {
    ...
    public HistorialPrestamoBibliotecario(IControlador controlador) {
    ...
    private void consultarHistorialBiblio() {
        try {
            ...
            // Validacion basica
            if (nroEmpleado.isEmpty()) {
                JOptionPane.showMessageDialog(this, 
                    "Debe ingresar el numero de empleado del bibliotecario", 
                    "Error de Validacion", 
            ...
            ArrayList<DtPrestamo> prestamos = controlador.ListarPrestamoBiblioteacrio(nroEmpleado);
